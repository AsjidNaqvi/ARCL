...
const FinancialStatements = () => {
  const statements = [
    { year: "2018", url: "/audit/2018.pdf" },
    { year: "2019", url: "/audit/2019.pdf" },
    { year: "2020", url: "/audit/2020.pdf" },
    { year: "2021", url: "/audit/2021.pdf" },
    { year: "2022", url: "/audit/2022.pdf" },
    { year: "2023", url: "/audit/2023.pdf" },
  ];
    ...
    <div className="max-w-7xl mx-auto px-6 py-16">
      <section className="bg-white p-8 border border-gray-200 shadow-lg rounded-lg">
        ...
        <p className="text-lg mb-8 max-w-3xl mx-auto text-blue-950/80 text-center">
          Access our annual audit reports to stay informed about our Audit
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-lg font-semibold">
                  Audit Reports FY {statement.year}
                </span>
              </div>
            </Link>
          ))}
